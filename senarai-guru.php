...
<head>
    ...
    <link rel="stylesheet" href="css/senarai-guru.css">
...
<body>
    ...
    <div class="main-content">
        <div class="header-row">
            <h2 class="section-title">Senarai Guru</h2>

            <form method="GET" class="search-form" id="searchForm" onsubmit="return false;">
                <input type="text" name="search" id="searchInput" placeholder="Cari Guru...">
                <button type="submit"><i class="fas fa-search"></i></button>
            </form>
        </div>

        <div id="teacher-results">
            <?php include 'senarai-guru-table.php'; ?>
        </div>
    ...
    <script>
        ...
        document.getElementById("searchInput").addEventListener("keyup", function() {
            ...
            xhr.open("GET", "senarai-guru-table.php?search=" + encodeURIComponent(query), true);
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    document.getElementById("teacher-results").innerHTML = xhr.responseText;
                }
            };
            xhr.send();
        });
